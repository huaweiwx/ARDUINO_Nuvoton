...
#ifdef USE_BoardToPin
const BoardToPin BoardToPinInfo[] = {{ 32, UART_TYPE, 0}, // 0: PB0(UART_RX0)
...
#ifdef USE_BoardToPin
const BoardToPin BoardToPinInfo[] = {{ 73, UART_TYPE, 0}, // 0: PC10(UART_RX0)
...
#ifdef USE_BoardToPin
const BoardToPin BoardToPinInfo[] = {{ 5, GPIO_TYPE, 0}, // 0: PC4
