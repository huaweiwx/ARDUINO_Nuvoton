...
/* IN(    ,25),  VDD                                                                */\
/* IN(    ,26),  LDO_CAP                                                            */\
PIN(C,0 ,27), /* SPI2_CLK/UART2_nCTS/CAN0_TXD/PWM0_CH0/EBI_AD8/INT2                 */\
PIN(C,1 ,28), /* CLKO/STDAC/UART2_nRTS/CAN0_RXD/PWM0_CH1/EBI_AD9                    */\
...
PIN(A,1 ,51), /* UART1_nRTS/UART1_RXD/CAN0_TXD/SC0_DAT/PWM1_CH4/EBI_AD1             */\
PIN(A,0 ,52), /* UART1_nCTS/UART1_TXD/CAN0_RXD/SC0_CLK/PWM1_CH5/EBI_AD0/INT0        */\
/* IN(    ,53),  VSS                                                                */\
/* IN(    ,54),  VDD                                                                */\
/* IN(    ,55),  AVDD                                                               */\
/* IN(    ,56),  VREF                                                               */\
