...
PIN(D,7 ,32), /* PWM0_SYNC_IN/T1/ACMP0_O/PWM0_CH5/EBI_nRD                        */\
PIN(F,3 ,33), /* XT1_OUT/I2C1_SCL                                                */\
PIN(F,4 ,34), /* XT1_IN/I2C1_SDA                                                 */\
      /* 35      VSS                                                             */\
      /* 36      VDD                                                             */\
      /* 37      LDO_CAP                                                         */\
PIN(C,9 ,38), /* SPI2_I2SMCLK/PWM1_CH0                                           */\
...
PIN(C,0 ,44), /* SPI2_CLK/UART2_nCTS/PWM0_CH0/EBI_AD8/INT2                       */\
PIN(C,1 ,45), /* CLKO/STDAC/UART2_nRTS/PWM0_CH1/EBI_AD9                          */\
PIN(C,2 ,46), /* SPI2_SS/UART2_TXD/ACMP1_O/PWM0_CH2/EBI_AD10                     */\
PIN(C,3 ,47), /* SPI2_MOSI/UART2_RXD/PWM0_CH3/EBI_AD11                           */\
PIN(C,4 ,48), /* SPI2_MISO/I2C1_SCL/PWM0_CH4/EBI_AD12                            */\
...
PIN(A,10,59), /* UART3_nCTS                                                      */\
PIN(A,11,60), /* UART3_nRTS                                                      */\
PIN(E,6 ,61), /* T3_EXT                                                          */\
PIN(A,7 ,62), /* SPI1_CLK/T0_EXT/EBI_AD7                                         */\
PIN(A,6 ,63), /* SPI1_MISO/T1_EXT/EBI_AD6                                        */\
PIN(A,5 ,64), /* SPI1_MOSI/T2_EXT/EBI_AD5                                        */\
PIN(A,4 ,65), /* SPI1_SS/EBI_AD4                                                 */\
      /* 66), VSS                                                                */\
      /* 67), VDD                                                                */\
PIN(E,1 ,68), /* T3_EXT/SC0_CD/PWM0_CH1                                          */\
PIN(E,8 ,69), /* UART1_TXD/SPI0_MISO1/I2C1_SCL/SC0_PWR                           */\
PIN(E,9 ,70), /* UART1_RXD/SPI0_MOSI1/I2C1_SDA/SC0_RST                           */\
PIN(E,10,71), /* SPI1_MISO/SPI0_MISO0/UART1_nCTS/I2C0_SMBAL/SC0_DAT              */\
PIN(E,11,72), /* SPI1_MOSI/SPI0_MOSI0/UART1_nRTS/I2C0_SMBSUS/SC0_CLK             */\
PIN(E,12,73), /* SPI1_SS/SPI0_SS/UART1_TXD/I2C0_SCL                              */\
PIN(E,13,74), /* SPI1_CLK/SPI0_CLK/UART1_RXD/I2C0_SDA                            */\
 /*      75), VDDIO                                                           */\
PIN(E,7 ,76), /*                                                                 */\
PIN(C,15,77), /* PWM1_CH0                                                        */\
PIN(E,2 ,78), /* PWM1_CH1                                                        */\
PIN(A,3 ,79), /* UART0_RXD/UART0_nRTS/I2C0_SCL/SC0_PWR/PWM1_CH2/EBI_AD3          */\
PIN(A,2 ,80), /* UART0_TXD/UART0_nCTS/I2C0_SDA/SC0_RST/PWM1_CH3/EBI_AD2          */\
PIN(A,1 ,81), /* UART1_nRTS/UART1_RXD/SC0_DAT/PWM1_CH4/EBI_AD1                   */\
PIN(A,0 ,82), /* UART1_nCTS/UART1_TXD/SC0_CLK/PWM1_CH5/EBI_AD0/INT0              */\
PIN(A,12,83), /* SPI1_I2SMCLK                                                    */\
PIN(A,13,84), /*                                                                 */\
