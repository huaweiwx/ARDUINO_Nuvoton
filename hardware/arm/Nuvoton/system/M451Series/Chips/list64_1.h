...
PIN(C,3 ,30),  /* SPI2_MOSI/UART2_RXD/PWM0_CH3/EBI_AD11                           */\
PIN(C,4 ,31),  /* SPI2_MISO/I2C1_SCL/PWM0_CH4/EBI_AD12                            */\
PIN(E,0 ,32),  /* SPI2_CLK/I2C1_SDA/T2_EXT/SC0_CD/PWM0_CH0/EBI_nCS1/INT4          */\
PIN(C,5 ,33),  /* SPI2_I2SMCLK/PWM0_CH5/EBI_AD13                                  */\
PIN(C,6 ,34),  /* I2C1_SMBAL/ACMP1_O/PWM1_CH0/EBI_AD14                            */\
PIN(C,7 ,35),  /* I2C1_SMBSUS/PWM1_CH1/EBI_AD15                                   */\
/*PIN(F,5 ,36),   ICE_CLK                                                         */\
/*PIN(F,6 ,37),   ICE_DAT                                                         */\
PIN(A,7 ,38),  /* SPI1_CLK/T0_EXT/EBI_AD7                                         */\
PIN(A,6 ,39),  /* SPI1_MISO/T1_EXT/EBI_AD6                                        */\
PIN(A,5 ,40),  /* SPI1_MOSI/T2_EXT/EBI_AD5                                        */\
PIN(A,4 ,41),  /* SPI1_SS/EBI_AD4                                                 */\
PIN(E,8 ,42),  /* UART1_TXD/SPI0_MISO1/I2C1_SCL/SC0_PWR                           */\
PIN(E,9 ,43),  /* UART1_RXD/SPI0_MOSI1/I2C1_SDA/SC0_RST                           */\
PIN(E,10,44),  /* SPI1_MISO/SPI0_MISO0/UART1_nCTS/I2C0_SMBAL/SC0_DAT              */\
PIN(E,11,45),  /* SPI1_MOSI/SPI0_MOSI0/UART1_nRTS/I2C0_SMBSUS/SC0_CLK             */\
PIN(E,12,46),  /* SPI1_SS/SPI0_SS/UART1_TXD/I2C0_SCL                              */\
PIN(E,13,47),  /* SPI1_CLK/SPI0_CLK/UART1_RXD/I2C0_SDA                            */\
/* IN( ,  ,48),   VDDIO                                                           */\
PIN(A,3 ,49),  /* UART0_RXD/UART0_nRTS/I2C0_SCL/SC0_PWR/PWM1_CH2/EBI_AD3          */\
PIN(A,2 ,50),  /* UART0_TXD/UART0_nCTS/I2C0_SDA/SC0_RST/PWM1_CH3/EBI_AD2          */\
