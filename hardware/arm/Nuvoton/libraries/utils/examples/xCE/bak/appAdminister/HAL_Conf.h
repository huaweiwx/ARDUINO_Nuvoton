...
/*USE_SPIx default 1*/
#ifndef USE_SPI1
# define USE_SPI1 0 /*0 unused spi1 save space*/
#endif
...
#ifndef USE_SPI3
# define USE_SPI3 0 /*0 unused spi3 save space*/
#endif

#ifndef USE_SPI4
# define USE_SPI4 0 /*0 unused spi4 save space*/
#endif

#if !defined(ARDUINO_IGT6CORE)
# define USE_SPI5 0 /*0 unused spi5 save space*/
#endif

#ifndef USE_SPI6
# define USE_SPI6 0 /*0 unused spi6 save space*/
#endif
