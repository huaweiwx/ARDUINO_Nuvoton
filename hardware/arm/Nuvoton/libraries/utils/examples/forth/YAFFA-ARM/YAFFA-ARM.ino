...
char cInputBuffer[YFBUFFER_SIZE]; // Input Buffer that gets parsed
...
void setup(void) {                
  ...
  Serial.println((size_t)cInputBuffer[YFBUFFER_SIZE] - 1, HEX);
...
void loop(void) {
  ...
  cpSourceEnd = cpSource + getLine(cpSource, YFBUFFER_SIZE);
